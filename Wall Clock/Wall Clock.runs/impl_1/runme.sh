...
HD_PWD='C:/Users/tshum/OneDrive/Documents/FINAL_YEAR/1st_Semester/EEE4120F_HPEC/prac_four/Prac4/Wall Clock/Wall Clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WallClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WallClock.tcl -notrace
