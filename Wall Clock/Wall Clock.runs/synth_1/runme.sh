...
HD_PWD='C:/Users/tshum/OneDrive/Documents/FINAL_YEAR/1st_Semester/EEE4120F_HPEC/prac_four/Prac4/Wall Clock/Wall Clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WallClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WallClock.tcl
